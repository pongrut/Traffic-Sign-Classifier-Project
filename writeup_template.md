...
I use numpy to store all training, testing and validation datasets and labels then uses pandas in retrieving the names of all 43 classes from the csv file, the summary statistics of the traffic
signs data set:
